...
class JTextLineNumber @JvmOverloads constructor(
     ...
     *
     * @param digitAlignment to align direction
     */
    ...
    public override fun paintComponent(g: Graphics) {
        ...
        var rowStartOffset = component.viewToModel2D(Point(0, clip.y))
        val endOffset = component.viewToModel2D(Point(0, clip.y + clip.height))
    ...
    private fun getOffsetY(rowStartOffset: Int, fontMetrics: FontMetrics): Int {
        ...
        val r = component.modelToView2D(rowStartOffset)
        ...
        if (r.height.toInt() == lineHeight) // default font is being used
        {
    ...
    private fun documentChanged() {
        ...
        SwingUtilities.invokeLater {
            try {
                ...
                if (rect != null && rect.y.toInt() != lastHeight) {
                    setPreferredWidth()
                    //repaint();
                    parent.repaint()
